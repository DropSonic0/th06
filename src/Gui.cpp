...
ZunResult Gui::ActualAddedCallback()
{
	...
	this->impl->bombSpellcardName.fontWidth = GamePaths::IsJapanese() ? 15 : 15;
	this->impl->bombSpellcardName.fontHeight = GamePaths::IsJapanese() ? 15 : 15;
	this->impl->enemySpellcardName.fontWidth = GamePaths::IsJapanese() ? 15 : 15;
	this->impl->enemySpellcardName.fontHeight = GamePaths::IsJapanese() ? 15 : 15;
	...
	this->impl->songNameSprite.fontWidth = GamePaths::IsJapanese() ? 16 : 10;
	this->impl->songNameSprite.fontHeight = GamePaths::IsJapanese() ? 16 : 16;
...
void GuiImpl::MsgRead(i32 msgIdx)
{
	...
	this->msg.fontSize = GamePaths::IsJapanese() ? 15 : 11;
...
ZunResult GuiImpl::RunMsg()
{
	...
	while ((i32)(this->msg.timer.current >= (i32)(u16)this->msg.currentInstr->time))
	{
		...
		case MSG_OPCODE_MUSIC:
			...
			this->songNameSprite.fontWidth = GamePaths::IsJapanese() ? 16 : 10;
			this->songNameSprite.fontHeight = GamePaths::IsJapanese() ? 16 : 16;

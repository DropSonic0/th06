...
void WebGL::CopyTextureFromBackbuffer(i32 x, i32 y, i32 width, i32 height)
{
    g_glFuncTable.glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
    g_glFuncTable.glCopyTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, x, y, width, height);
}

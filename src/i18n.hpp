...
#define TH_JP_WINDOW_TITLE "Touhou Koumakyou ~ the Embodiment of Scarlet Devil"
#define TH_JP_DBG_MAINMENU_VRAM "Debug : title menu VRAM = %d\n"
#define TH_JP_DBG_RESULTSCREEN_COUNAT "counat = %d\n"
#define TH_JP_ERR_ALREADY_RUNNING "Touhou cannot be started\n"
#define TH_JP_ERR_D3D_COULD_NOT_CREATE_OBJ "Direct3D object could not be created for some reason\n"
#define TH_JP_ERR_LOGGER_START "Logger started --------------------------------------------- \n"
#define TH_JP_ERR_LOGGER_END "---------------------------------------------------------- \n"
#define TH_JP_ERR_NO_PAD_FOUND "Unfortunately, there doesn't seem to be a pad that can be used.\n"
#define TH_JP_ERR_OPTION_CHANGED_RESTART "An option that requires a restart has been changed.\n"
#define TH_JP_ERR_SCREEN_INIT_32BITS "First startup, screen initialized with 32Bits.\n"
#define TH_JP_ERR_SCREEN_INIT_16BITS "First startup, screen initialized with 16Bits.\n"
#define TH_JP_ERR_SET_REFRESH_RATE_60HZ "Setting the refresh rate to 60Hz.\n"
#define TH_JP_ERR_TL_HAL_UNAVAILABLE "T&L HAL does not appear to be available.\n"
#define TH_JP_ERR_HAL_UNAVAILABLE "HAL does not appear to be available either.\n"
#define TH_JP_ERR_D3D_INIT_FAILED "Direct3D initialization failed, the game cannot be played.\n"
#define TH_JP_ERR_BACKBUFFER_NONLOCKED "Retrying to create D3D context without locked backbuffer.\n"
#define TH_JP_ERR_CANT_CHANGE_REFRESH_RATE_FORCE_VSYNC "Unable to set refresh rate, enabling vsync.\n"
#define TH_JP_USING_REF_MODE "Using REF mode, expect heavy lag...\n"
#define TH_JP_USING_HAL_MODE "Using HAL mode.\n"
#define TH_JP_USING_TL_HAL_MODE "Using T&L HAL mode.\n"
#define TH_JP_ERR_NO_SUPPORT_FOR_D3DTEXOPCAPS_ADD                                                                      \
...
#define TH_JP_ERR_D3DFMT_A8R8G8B8_UNSUPPORTED "D3DFMT_A8R8G8B8 not supported, operating in reduced color mode.\n"
#define TH_JP_ERR_CONFIG_NOT_FOUND "Config not found, initializing with default values.\n"
#define TH_JP_ERR_CONFIG_CORRUPTED "Config corrupted, reinitializing with default values.\n"
#define TH_JP_ERR_NO_WAVE_FILE "There is no wave data, so I'll make it midi!\n"
#define TH_JP_ERR_NOT_A_WAV_FILE "%s isn't a wav file?"
#define TH_JP_ERR_NO_VERTEX_BUFFER "Suppressing the use of the vertex buffer.\n"
#define TH_JP_ERR_NO_FOG "Suppressing the use of fog.\n"
#define TH_JP_ERR_USE_16BIT_TEXTURES "Enforces the use of 16Bit textures.\n"
#define TH_JP_ERR_FORCE_BACKBUFFER_CLEAR "Force clearing of the back buffer.\n"
#define TH_JP_ERR_DONT_RENDER_ITEMS "Suppress the rendering of items around the game.\n"
#define TH_JP_ERR_NO_GOURAUD_SHADING "Suppress gouraud shading.\n"
#define TH_JP_ERR_NO_DEPTH_TESTING "Suppress depth testing.\n"
#define TH_JP_ERR_FORCE_60FPS_MODE "Force 60FPS mode.\n"
#define TH_JP_ERR_NO_TEXTURE_COLOR_COMPOSITING "Suppress texture color compositing.\n"
#define TH_JP_ERR_LAUNCH_WINDOWED "Launch in windowed mode.\n"
#define TH_JP_ERR_FORCE_REFERENCE_RASTERIZER "Force reference rasterizer.\n"
#define TH_JP_ERR_DO_NOT_USE_DIRECTINPUT "Do not use DirectInput for pad and keyboard input.\n"
#define TH_JP_ERR_DIRECTINPUT_NOT_AVAILABLE "DirectInput is not available.\n"
#define TH_JP_ERR_DIRECTINPUT_SETDATAFORMAT_NOT_AVAILABLE "DirectInput SetDataFormat is not available.\n"
#define TH_JP_ERR_DIRECTINPUT_SETCOOPERATIVELEVEL_NOT_AVAILABLE "DirectInput SetCooperativeLevel is not available.\n"
#define TH_JP_ERR_DIRECTINPUT_INITIALIZED "DirectInput was successfully initialized.\n"
#define TH_JP_ERR_PAD_FOUND "Found a valid pad.\n"
#define TH_JP_ERR_FILE_CANNOT_BE_EXPORTED "File cannot be exported %s.\n"
#define TH_JP_ERR_FOLDER_HAS_WRITE_PROTECT_OR_DISK_FULL "Folder has write protect attribute or disk full?\n"
#define TH_JP_ERR_ASCIIMANAGER_INIT_FAILED "error: AsciiManager initialization failed\n"
#define TH_JP_ERR_WRONG_DATA_VERSION "error: Wrong data version\n"
#define TH_JP_ERR_CANNOT_BE_LOADED "%s cannot be loaded.\n"
#define TH_JP_ERR_ANMMANAGER_SPRITE_CORRUPTED "Unable to load sprite animation %s. Data is lost or corrupted.\n"
#define TH_JP_ERR_ANMMANAGER_TEXTURE_CORRUPTED "Unable to load texture %s. Data is lost or corrupted.\n"
#define TH_JP_ERR_ANMMANAGER_UNK_TEX_FORMAT "error : Image does not have a valid format\n"
#define TH_JP_ERR_ECLMANAGER_ENEMY_DATA_CORRUPT "Failed to load enemy data, data is corrupt or lost.\n"
#define TH_JP_ERR_ENDING_END_FILE_CORRUPTED "error : Ending file cannot be loaded, the file is corrupted.\n"
#define TH_JP_ERR_MAINMENU_LOAD_SELECT_SCREEN_FAILED "Failed to load character/difficulty selection screen\n"
#define TH_JP_ERR_SOUNDPLAYER_FAILED_TO_CREATE_BGM_SOUND_BUFFER "error: Could not create sound buffer for music\n"
#define TH_JP_ERR_SOUNDPLAYER_FAILED_TO_INITIALIZE_OBJECT "DirectSound: Failed to initialize object\n"
#define TH_JP_ERR_SOUNDPLAYER_FAILED_TO_LOAD_SOUND_FILE "error: Could not load sound file %s\n"
#define TH_JP_DBG_SOUNDPLAYER_INIT_SUCCESS "DirectSound initialized successfully\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_STAGE "error : Failed to initialize Stage.\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_PLAYER "error : Failed to initialize Player.\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_BULLETMANAGER "error : Failed to initialize BulletManager.\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ENEMYMANAGER "error : Failed to initialize EnemyManager.\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ECLMANAGER "error : Failed to initialize EclManager.\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_EFFECTMANAGER "error : Failed to initialize EffectManager.\n"
#define TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_GUI "error : Failed to initialize Gui.\n"
#define TH_JP_ERR_GUI_MSG_FILE_CORRUPTED "error : message file %s could not be read.\n"
#define TH_JP_ERR_STAGE_DATA_CORRUPTED "Stage data not found. Data is corrupted.\n"
#define TH_JP_ERR_MIDI_FAILED_TO_READ_FILE "error : MIDI File %s could not be read.\n"
#define TH_JP_ERR_MIDI_NOT_LOADED "error : MIDI not loaded before being playback started.\n"
#define TH_JP_ERR_NO_MIDI_SUPPORT "Warning: build doesn't contain support for MIDI output.\n"
#define TH_JP_ERR_FONTS_NOT_FOUND "Couldn't find font files.\n"

#define TH_JP_REIMU_A_BOMB_NAME "Spirit Sign \"Dream Seal\""
#define TH_JP_REIMU_B_BOMB_NAME "Dream Sign \"Evil-Sealing Circle\""
#define TH_JP_MARISA_A_BOMB_NAME "Magic Sign \"Stardust Reverie\""
#define TH_JP_MARISA_B_BOMB_NAME "Love Sign \"Master Spark\""

#define TH_JP_HAKUREI_REIMU_SPIRIT "Hakurei Reimu (Spirit)"
#define TH_JP_HAKUREI_REIMU_DREAM "Hakurei Reimu (Dream)"
#define TH_JP_KIRISAME_MARISA_DEVIL "Kirisame Marisa (Devil)"
#define TH_JP_KIRISAME_MARISA_LOVE "Kirisame Marisa (Love)"
#define TH_JP_SATSUKI_RIN_FLOWER "Satsuki Rin (Flower)"
#define TH_JP_SATSUKI_RIN_WIND "Satsuki Rin (Wind)"

#define TH_JP_UNKNOWN_SPELLCARD "??????"

#define TH_JP_CM_DAT_FILE "KOUMAKYO_CM.dat"
#define TH_JP_ED_DAT_FILE "KOUMAKYO_ED.dat"
#define TH_JP_IN_DAT_FILE "KOUMAKYO_IN.dat"
#define TH_JP_MD_DAT_FILE "KOUMAKYO_MD.dat"
#define TH_JP_ST_DAT_FILE "KOUMAKYO_ST.dat"
#define TH_JP_TL_DAT_FILE "KOUMAKYO_TL.dat"
...
#define TH_ERR_NO_MIDI_SUPPORT TH_MAKE_LANG_STR(TH_LANG, _ERR_NO_MIDI_SUPPORT)

...
#define TH_JP_ERR_NO_MIDI_SUPPORT "このビルドにシステムMIDI APIじゃありません\n"
...
#define TH_EN_ERR_NO_MIDI_SUPPORT "Warning: build doesn't contain support for MIDI output.\n"
...
#define TH_CONFIG_FILE (GamePaths::IsJapanese() ? TH_JP_CONFIG_FILE : TH_EN_CONFIG_FILE)
#define TH_WINDOW_TITLE (GamePaths::IsJapanese() ? TH_JP_WINDOW_TITLE : TH_EN_WINDOW_TITLE)
#define TH_DBG_MAINMENU_VRAM (GamePaths::IsJapanese() ? TH_JP_DBG_MAINMENU_VRAM : TH_EN_DBG_MAINMENU_VRAM)
#define TH_DBG_RESULTSCREEN_COUNAT (GamePaths::IsJapanese() ? TH_JP_DBG_RESULTSCREEN_COUNAT : TH_EN_DBG_RESULTSCREEN_COUNAT)
#define TH_ERR_ALREADY_RUNNING (GamePaths::IsJapanese() ? TH_JP_ERR_ALREADY_RUNNING : TH_EN_ERR_ALREADY_RUNNING)
#define TH_ERR_D3D_ERR_COULD_NOT_CREATE_OBJ (GamePaths::IsJapanese() ? TH_JP_ERR_D3D_COULD_NOT_CREATE_OBJ : TH_EN_ERR_D3D_COULD_NOT_CREATE_OBJ)
#define TH_ERR_LOGGER_START (GamePaths::IsJapanese() ? TH_JP_ERR_LOGGER_START : TH_EN_ERR_LOGGER_START)
#define TH_ERR_LOGGER_END (GamePaths::IsJapanese() ? TH_JP_ERR_LOGGER_END : TH_EN_ERR_LOGGER_END)
#define TH_ERR_NO_PAD_FOUND (GamePaths::IsJapanese() ? TH_JP_ERR_NO_PAD_FOUND : TH_EN_ERR_NO_PAD_FOUND)
#define TH_ERR_OPTION_CHANGED_RESTART (GamePaths::IsJapanese() ? TH_JP_ERR_OPTION_CHANGED_RESTART : TH_EN_ERR_OPTION_CHANGED_RESTART)
#define TH_ERR_SCREEN_INIT_32BITS (GamePaths::IsJapanese() ? TH_JP_ERR_SCREEN_INIT_32BITS : TH_EN_ERR_SCREEN_INIT_32BITS)
#define TH_ERR_SCREEN_INIT_16BITS (GamePaths::IsJapanese() ? TH_JP_ERR_SCREEN_INIT_16BITS : TH_EN_ERR_SCREEN_INIT_16BITS)
#define TH_ERR_SET_REFRESH_RATE_60HZ (GamePaths::IsJapanese() ? TH_JP_ERR_SET_REFRESH_RATE_60HZ : TH_EN_ERR_SET_REFRESH_RATE_60HZ)
#define TH_ERR_TL_HAL_UNAVAILABLE (GamePaths::IsJapanese() ? TH_JP_ERR_TL_HAL_UNAVAILABLE : TH_EN_ERR_TL_HAL_UNAVAILABLE)
#define TH_ERR_HAL_UNAVAILABLE (GamePaths::IsJapanese() ? TH_JP_ERR_HAL_UNAVAILABLE : TH_EN_ERR_HAL_UNAVAILABLE)
#define TH_ERR_D3D_INIT_FAILED (GamePaths::IsJapanese() ? TH_JP_ERR_D3D_INIT_FAILED : TH_EN_ERR_D3D_INIT_FAILED)
#define TH_ERR_BACKBUFFER_NONLOCKED (GamePaths::IsJapanese() ? TH_JP_ERR_BACKBUFFER_NONLOCKED : TH_EN_ERR_BACKBUFFER_NONLOCKED)
#define TH_ERR_CANT_CHANGE_REFRESH_RATE_FORCE_VSYNC (GamePaths::IsJapanese() ? TH_JP_ERR_CANT_CHANGE_REFRESH_RATE_FORCE_VSYNC : TH_EN_ERR_CANT_CHANGE_REFRESH_RATE_FORCE_VSYNC)
#define TH_USING_REF_MODE (GamePaths::IsJapanese() ? TH_JP_USING_REF_MODE : TH_EN_USING_REF_MODE)
#define TH_USING_HAL_MODE (GamePaths::IsJapanese() ? TH_JP_USING_HAL_MODE : TH_EN_USING_HAL_MODE)
#define TH_USING_TL_HAL_MODE (GamePaths::IsJapanese() ? TH_JP_USING_TL_HAL_MODE : TH_EN_USING_TL_HAL_MODE)
#define TH_ERR_NO_SUPPORT_FOR_D3DTEXOPCAPS_ADD (GamePaths::IsJapanese() ? TH_JP_ERR_NO_SUPPORT_FOR_D3DTEXOPCAPS_ADD : TH_EN_ERR_NO_SUPPORT_FOR_D3DTEXOPCAPS_ADD)
#define TH_ERR_CANT_FORCE_60FPS_NO_ASYNC_FLIP (GamePaths::IsJapanese() ? TH_JP_ERR_CANT_FORCE_60FPS_NO_ASYNC_FLIP : TH_EN_ERR_CANT_FORCE_60FPS_NO_ASYNC_FLIP)
#define TH_ERR_D3DFMT_A8R8G8B8_UNSUPPORTED (GamePaths::IsJapanese() ? TH_JP_ERR_D3DFMT_A8R8G8B8_UNSUPPORTED : TH_EN_ERR_D3DFMT_A8R8G8B8_UNSUPPORTED)
#define TH_ERR_CONFIG_NOT_FOUND (GamePaths::IsJapanese() ? TH_JP_ERR_CONFIG_NOT_FOUND : TH_EN_ERR_CONFIG_NOT_FOUND)
#define TH_ERR_CONFIG_CORRUPTED (GamePaths::IsJapanese() ? TH_JP_ERR_CONFIG_CORRUPTED : TH_EN_ERR_CONFIG_CORRUPTED)
#define TH_ERR_NO_WAVE_FILE (GamePaths::IsJapanese() ? TH_JP_ERR_NO_WAVE_FILE : TH_EN_ERR_NO_WAVE_FILE)
#define TH_ERR_NOT_A_WAV_FILE (GamePaths::IsJapanese() ? TH_JP_ERR_NOT_A_WAV_FILE : TH_EN_ERR_NOT_A_WAV_FILE)
#define TH_ERR_NO_VERTEX_BUFFER (GamePaths::IsJapanese() ? TH_JP_ERR_NO_VERTEX_BUFFER : TH_EN_ERR_NO_VERTEX_BUFFER)
#define TH_ERR_NO_FOG (GamePaths::IsJapanese() ? TH_JP_ERR_NO_FOG : TH_EN_ERR_NO_FOG)
#define TH_ERR_USE_16BIT_TEXTURES (GamePaths::IsJapanese() ? TH_JP_ERR_USE_16BIT_TEXTURES : TH_EN_ERR_USE_16BIT_TEXTURES)
#define TH_ERR_FORCE_BACKBUFFER_CLEAR (GamePaths::IsJapanese() ? TH_JP_ERR_FORCE_BACKBUFFER_CLEAR : TH_EN_ERR_FORCE_BACKBUFFER_CLEAR)
#define TH_ERR_DONT_RENDER_ITEMS (GamePaths::IsJapanese() ? TH_JP_ERR_DONT_RENDER_ITEMS : TH_EN_ERR_DONT_RENDER_ITEMS)
#define TH_ERR_NO_GOURAUD_SHADING (GamePaths::IsJapanese() ? TH_JP_ERR_NO_GOURAUD_SHADING : TH_EN_ERR_NO_GOURAUD_SHADING)
#define TH_ERR_NO_DEPTH_TESTING (GamePaths::IsJapanese() ? TH_JP_ERR_NO_DEPTH_TESTING : TH_EN_ERR_NO_DEPTH_TESTING)
#define TH_ERR_FORCE_60FPS_MODE (GamePaths::IsJapanese() ? TH_JP_ERR_FORCE_60FPS_MODE : TH_EN_ERR_FORCE_60FPS_MODE)
#define TH_ERR_NO_TEXTURE_COLOR_COMPOSITING (GamePaths::IsJapanese() ? TH_JP_ERR_NO_TEXTURE_COLOR_COMPOSITING : TH_EN_ERR_NO_TEXTURE_COLOR_COMPOSITING)
#define TH_ERR_LAUNCH_WINDOWED (GamePaths::IsJapanese() ? TH_JP_ERR_LAUNCH_WINDOWED : TH_EN_ERR_LAUNCH_WINDOWED)
#define TH_ERR_FORCE_REFERENCE_RASTERIZER (GamePaths::IsJapanese() ? TH_JP_ERR_FORCE_REFERENCE_RASTERIZER : TH_EN_ERR_FORCE_REFERENCE_RASTERIZER)
#define TH_ERR_DO_NOT_USE_DIRECTINPUT (GamePaths::IsJapanese() ? TH_JP_ERR_DO_NOT_USE_DIRECTINPUT : TH_EN_ERR_DO_NOT_USE_DIRECTINPUT)
#define TH_ERR_DIRECTINPUT_NOT_AVAILABLE (GamePaths::IsJapanese() ? TH_JP_ERR_DIRECTINPUT_NOT_AVAILABLE : TH_EN_ERR_DIRECTINPUT_NOT_AVAILABLE)
#define TH_ERR_DIRECTINPUT_SETDATAFORMAT_NOT_AVAILABLE                                                                 \
    (GamePaths::IsJapanese() ? TH_JP_ERR_DIRECTINPUT_SETDATAFORMAT_NOT_AVAILABLE : TH_EN_ERR_DIRECTINPUT_SETDATAFORMAT_NOT_AVAILABLE)
#define TH_ERR_DIRECTINPUT_SETCOOPERATIVELEVEL_NOT_AVAILABLE                                                           \
    (GamePaths::IsJapanese() ? TH_JP_ERR_DIRECTINPUT_SETCOOPERATIVELEVEL_NOT_AVAILABLE : TH_EN_ERR_DIRECTINPUT_SETCOOPERATIVELEVEL_NOT_AVAILABLE)
#define TH_ERR_DIRECTINPUT_INITIALIZED (GamePaths::IsJapanese() ? TH_JP_ERR_DIRECTINPUT_INITIALIZED : TH_EN_ERR_DIRECTINPUT_INITIALIZED)
#define TH_ERR_PAD_FOUND (GamePaths::IsJapanese() ? TH_JP_ERR_PAD_FOUND : TH_EN_ERR_PAD_FOUND)
#define TH_ERR_FILE_CANNOT_BE_EXPORTED (GamePaths::IsJapanese() ? TH_JP_ERR_FILE_CANNOT_BE_EXPORTED : TH_EN_ERR_FILE_CANNOT_BE_EXPORTED)
#define TH_ERR_FOLDER_HAS_WRITE_PROTECT_OR_DISK_FULL                                                                   \
    (GamePaths::IsJapanese() ? TH_JP_ERR_FOLDER_HAS_WRITE_PROTECT_OR_DISK_FULL : TH_EN_ERR_FOLDER_HAS_WRITE_PROTECT_OR_DISK_FULL)
#define TH_ERR_ASCIIMANAGER_INIT_FAILED (GamePaths::IsJapanese() ? TH_JP_ERR_ASCIIMANAGER_INIT_FAILED : TH_EN_ERR_ASCIIMANAGER_INIT_FAILED)
#define TH_ERR_WRONG_DATA_VERSION (GamePaths::IsJapanese() ? TH_JP_ERR_WRONG_DATA_VERSION : TH_EN_ERR_WRONG_DATA_VERSION)
#define TH_ERR_CANNOT_BE_LOADED (GamePaths::IsJapanese() ? TH_JP_ERR_CANNOT_BE_LOADED : TH_EN_ERR_CANNOT_BE_LOADED)
#define TH_ERR_ANMMANAGER_SPRITE_CORRUPTED (GamePaths::IsJapanese() ? TH_JP_ERR_ANMMANAGER_SPRITE_CORRUPTED : TH_EN_ERR_ANMMANAGER_SPRITE_CORRUPTED)
#define TH_ERR_ANMMANAGER_TEXTURE_CORRUPTED (GamePaths::IsJapanese() ? TH_JP_ERR_ANMMANAGER_TEXTURE_CORRUPTED : TH_EN_ERR_ANMMANAGER_TEXTURE_CORRUPTED)
#define TH_ERR_ANMMANAGER_UNK_TEX_FORMAT (GamePaths::IsJapanese() ? TH_JP_ERR_ANMMANAGER_UNK_TEX_FORMAT : TH_EN_ERR_ANMMANAGER_UNK_TEX_FORMAT)
#define TH_ERR_ECLMANAGER_ENEMY_DATA_CORRUPT (GamePaths::IsJapanese() ? TH_JP_ERR_ECLMANAGER_ENEMY_DATA_CORRUPT : TH_EN_ERR_ECLMANAGER_ENEMY_DATA_CORRUPT)
#define TH_ERR_ENDING_END_FILE_CORRUPTED (GamePaths::IsJapanese() ? TH_JP_ERR_ENDING_END_FILE_CORRUPTED : TH_EN_ERR_ENDING_END_FILE_CORRUPTED)
#define TH_ERR_MAINMENU_LOAD_SELECT_SCREEN_FAILED (GamePaths::IsJapanese() ? TH_JP_ERR_MAINMENU_LOAD_SELECT_SCREEN_FAILED : TH_EN_ERR_MAINMENU_LOAD_SELECT_SCREEN_FAILED)
#define TH_ERR_SOUNDPLAYER_FAILED_TO_CREATE_BGM_SOUND_BUFFER                                                           \
    (GamePaths::IsJapanese() ? TH_JP_ERR_SOUNDPLAYER_FAILED_TO_CREATE_BGM_SOUND_BUFFER : TH_EN_ERR_SOUNDPLAYER_FAILED_TO_CREATE_BGM_SOUND_BUFFER)
#define TH_ERR_SOUNDPLAYER_FAILED_TO_INITIALIZE_OBJECT                                                                 \
    (GamePaths::IsJapanese() ? TH_JP_ERR_SOUNDPLAYER_FAILED_TO_INITIALIZE_OBJECT : TH_EN_ERR_SOUNDPLAYER_FAILED_TO_INITIALIZE_OBJECT)
#define TH_ERR_SOUNDPLAYER_FAILED_TO_LOAD_SOUND_FILE                                                                   \
    (GamePaths::IsJapanese() ? TH_JP_ERR_SOUNDPLAYER_FAILED_TO_LOAD_SOUND_FILE : TH_EN_ERR_SOUNDPLAYER_FAILED_TO_LOAD_SOUND_FILE)
#define TH_DBG_SOUNDPLAYER_INIT_SUCCESS (GamePaths::IsJapanese() ? TH_JP_DBG_SOUNDPLAYER_INIT_SUCCESS : TH_EN_DBG_SOUNDPLAYER_INIT_SUCCESS)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_STAGE                                                                  \
    (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_STAGE : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_STAGE)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_PLAYER                                                                 \
    (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_PLAYER : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_PLAYER)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_BULLETMANAGER                                                          \
    (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_BULLETMANAGER : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_BULLETMANAGER)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ENEMYMANAGER                                                           \
    (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ENEMYMANAGER : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ENEMYMANAGER)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ECLMANAGER                                                             \
    (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ECLMANAGER : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_ECLMANAGER)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_EFFECTMANAGER                                                          \
    (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_EFFECTMANAGER : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_EFFECTMANAGER)
#define TH_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_GUI (GamePaths::IsJapanese() ? TH_JP_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_GUI : TH_EN_ERR_GAMEMANAGER_FAILED_TO_INITIALIZE_GUI)
#define TH_ERR_GUI_MSG_FILE_CORRUPTED (GamePaths::IsJapanese() ? TH_JP_ERR_GUI_MSG_FILE_CORRUPTED : TH_EN_ERR_GUI_MSG_FILE_CORRUPTED)
#define TH_ERR_STAGE_DATA_CORRUPTED (GamePaths::IsJapanese() ? TH_JP_ERR_STAGE_DATA_CORRUPTED : TH_EN_ERR_STAGE_DATA_CORRUPTED)
#define TH_ERR_MIDI_FAILED_TO_READ_FILE (GamePaths::IsJapanese() ? TH_JP_ERR_MIDI_FAILED_TO_READ_FILE : TH_EN_ERR_MIDI_FAILED_TO_READ_FILE)
#define TH_ERR_MIDI_NOT_LOADED (GamePaths::IsJapanese() ? TH_JP_ERR_MIDI_NOT_LOADED : TH_EN_ERR_MIDI_NOT_LOADED)
#define TH_ERR_NO_MIDI_SUPPORT (GamePaths::IsJapanese() ? TH_JP_ERR_NO_MIDI_SUPPORT : TH_EN_ERR_NO_MIDI_SUPPORT)
#define TH_ERR_FONTS_NOT_FOUND (GamePaths::IsJapanese() ? TH_JP_ERR_FONTS_NOT_FOUND : TH_EN_ERR_FONTS_NOT_FOUND)
#define TH_REIMU_A_BOMB_NAME (GamePaths::IsJapanese() ? TH_JP_REIMU_A_BOMB_NAME : TH_EN_REIMU_A_BOMB_NAME)
#define TH_REIMU_B_BOMB_NAME (GamePaths::IsJapanese() ? TH_JP_REIMU_B_BOMB_NAME : TH_EN_REIMU_B_BOMB_NAME)
#define TH_MARISA_A_BOMB_NAME (GamePaths::IsJapanese() ? TH_JP_MARISA_A_BOMB_NAME : TH_EN_MARISA_A_BOMB_NAME)
#define TH_MARISA_B_BOMB_NAME (GamePaths::IsJapanese() ? TH_JP_MARISA_B_BOMB_NAME : TH_EN_MARISA_B_BOMB_NAME)
#define TH_HAKUREI_REIMU_SPIRIT (GamePaths::IsJapanese() ? TH_JP_HAKUREI_REIMU_SPIRIT : TH_EN_HAKUREI_REIMU_SPIRIT)
#define TH_HAKUREI_REIMU_DREAM (GamePaths::IsJapanese() ? TH_JP_HAKUREI_REIMU_DREAM : TH_EN_HAKUREI_REIMU_DREAM)
#define TH_KIRISAME_MARISA_DEVIL (GamePaths::IsJapanese() ? TH_JP_KIRISAME_MARISA_DEVIL : TH_EN_KIRISAME_MARISA_DEVIL)
#define TH_KIRISAME_MARISA_LOVE (GamePaths::IsJapanese() ? TH_JP_KIRISAME_MARISA_LOVE : TH_EN_KIRISAME_MARISA_LOVE)
#define TH_SATSUKI_RIN_FLOWER (GamePaths::IsJapanese() ? TH_JP_SATSUKI_RIN_FLOWER : TH_EN_SATSUKI_RIN_FLOWER)
#define TH_SATSUKI_RIN_WIND (GamePaths::IsJapanese() ? TH_JP_SATSUKI_RIN_WIND : TH_EN_SATSUKI_RIN_WIND)
#define TH_UNKNOWN_SPELLCARD (GamePaths::IsJapanese() ? TH_JP_UNKNOWN_SPELLCARD : TH_EN_UNKNOWN_SPELLCARD)
#define TH_CM_DAT_FILE (GamePaths::IsJapanese() ? TH_JP_CM_DAT_FILE : TH_EN_CM_DAT_FILE)
#define TH_ED_DAT_FILE (GamePaths::IsJapanese() ? TH_JP_ED_DAT_FILE : TH_EN_ED_DAT_FILE)
#define TH_IN_DAT_FILE (GamePaths::IsJapanese() ? TH_JP_IN_DAT_FILE : TH_EN_IN_DAT_FILE)
#define TH_MD_DAT_FILE (GamePaths::IsJapanese() ? TH_JP_MD_DAT_FILE : TH_EN_MD_DAT_FILE)
#define TH_ST_DAT_FILE (GamePaths::IsJapanese() ? TH_JP_ST_DAT_FILE : TH_EN_ST_DAT_FILE)
#define TH_TL_DAT_FILE (GamePaths::IsJapanese() ? TH_JP_TL_DAT_FILE : TH_EN_TL_DAT_FILE)
